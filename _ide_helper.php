...
namespace  {
    ...
    class App extends \Illuminate\Support\Facades\App {}
            ...
            public static function make($attributes = [])
            {
                 ...
                 * @static
                 */
            public static function whereCross(string $start, string $end, Duration $duration)
            {
                /** @var \Illuminate\Database\Eloquent\Builder $instance */
                return $instance->whereCross($start, $end, $duration);
            }
                /**
                 * @param string $start
                 * @param string $end
                 ...
                 * @static
                 */
                public static function orWhereCross(string $start, string $end, Duration $duration)
                {
                    /** @var \Illuminate\Database\Eloquent\Builder $instance */
                    return $instance->orWhereCross($start, $end, $duration);
                }
            ...
            class DynamicOperator extends \Illuminate\Support\Facades\Facade {}
